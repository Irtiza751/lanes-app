  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'transition-[width] duration-200 ease-in-expo relative w-(--sidebar-width) bg-transparent',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-in-expo md:flex',
          side === 'left'
